...
class LibroHandlerModel
{
   public static function getLibro($id){
       ...
       if($valid == true || $id == null){
           $query = "SELECT " . \ConstantesDB\ConsLibrosModel::ISBN . "," .\ConstantesDB\ConsLibrosModel::TITULO
               .",".\ConstantesDB\ConsLibrosModel::EJEMPLARES. "," . \ConstantesDB\ConsLibrosModel::PRECIO ."FROM" . \ConstantesDB\ConsLibrosModel::TABLE_NAME;
